...
tf.flags.DEFINE_string("train_data_file", "../data/comment_data.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("train_label_data_file", "", "Data source for the label data.")
tf.flags.DEFINE_string("w2v_file", "../data/comment_vector.bin", "w2v_file path")
