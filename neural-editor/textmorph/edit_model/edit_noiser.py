...
from editor import EditExample
...
class EditNoiser(object):
    ...
    def _noise(self, ex):
        ...
        if ident_map:
            return EditExample(ex.source_words,ex.title_words, [], [], [], [], ex.source_words)
        else:
            ...
            return EditExample(ex.source_words,ex.title_words, insert_approx, insert_exact, delete_approx, delete_exact, ex.target_words)
